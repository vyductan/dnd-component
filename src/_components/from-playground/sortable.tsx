...
import { Item as InternalItem } from "./_components/item";
...
export interface DndSortableProps<TRecord extends AnyObject = AnyObject> {
  ...
  renderItem?: ItemProps<TRecord>["renderItem"];
  onDragEnd?: (
...
export const Sortable = <TRecord extends AnyObject = AnyObject>({
  classNames,
  ...
  // ========================================================================
  // =================== Container ===================
  const Container = components?.container ?? List;
  // const Item = components?.item?.wrapper ?? InternalItem;
  ...
  return (
    ...
    >
      <SortableContext items={items} strategy={strategy}>
        <Container className={classNames?.list} {...props}>
          {items.map((item, index) => {
            const props = {
              ...
              animateLayoutChanges: item.animateLayoutChanges,
              useDragOverlay: item.useDragOverlay,
              getNewIndex: item.getNewIndex,
